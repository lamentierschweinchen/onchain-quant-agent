#!/usr/bin/env python3
"""Run #24 stage 1: compute every derived quantity -> /tmp/run24w/derived.json"""
import json, os, math
from datetime import datetime, timezone

REPO="/Users/ls/Documents/MultiversX/projects/onchain-quant-agent"
OUT="/tmp/run24w"; os.makedirs(OUT, exist_ok=True)
RD="2026-09-07"
...
prev_desk=132505.15989968902+133708.16077335872   # run #23 desk balances
upbit_feed=0.0
...
# wave #3 now spans three weekly frames: run #22 (Aug 17-24), #23 (Aug 24-31), #24 (this week)
sum_wave_weekly=prev_nets["run22"]+prev_nets["run23"]+vn["net_one_way"]
...
O["otc"]={
 ...
 "upbit_feed":upbit_feed,"prev_upbit_feed":460000.0,"feed_by_venue":feed_by_venue,
 ...
 "wave":{"window":"2026-08-17..2026-09-07","gross_out":wave["gross_out"],
...
try:
    _p22=json.load(open(f"{REPO}/data/collected/2026-08-31.json"))
