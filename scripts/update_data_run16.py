...
R=json.load(open(f"{REPO}/reports/2026-07-13.json"))
...
new_prev={
 ...
 "watch_addresses":[
   {"address":"erd1v6x9egd2j5cmr57cugxukfnn647q2zuy57nu68t0y6qpu6ztaypshcxnk5","label":"UPbit OTC Desk (RECORD RELOAD: +117K balance to ~168K, ~245K outbound 7d; fed by UPbit 460K; watch distribution leg)","balance_egld":b("erd1v6x9egd2j5cmr57cugxukfnn647q2zuy57nu68t0y6qpu6ztaypshcxnk5"),"weeks_tracked":16,"first_seen":"2026-04-02"},
   {"address":"erd1z7fnqf4mjknsx289t9qf9kv5yr2fts7uv8ssmuknq7546f8e6ceq2nm63r","label":"OTC Distribution Wallet (RECORD RELOAD: +120K balance to ~167K, ~78K outbound 7d; biggest desk load in tracking)","balance_egld":b("erd1z7fnqf4mjknsx289t9qf9kv5yr2fts7uv8ssmuknq7546f8e6ceq2nm63r"),"weeks_tracked":14,"first_seen":"2026-04-13"},
   {"address":"erd1rf4hv70arudgzus0ymnnsnc4pml0jkywg2xjvzslg0mz4nn2tg7q7k0t6p","label":"Binance Staking custody (2nd-leg drawdown -43K to 3.31M; -202K over 2 weeks from 3.51M peak; de-staking continues)","balance_egld":b("erd1rf4hv70arudgzus0ymnnsnc4pml0jkywg2xjvzslg0mz4nn2tg7q7k0t6p"),"weeks_tracked":10,"first_seen":"2026-05-11"},
   {"address":"erd18mv2z6r2ksn4rfmm52tmhkc6x5tz6achmynvxftq4ay927029qqqmqpzfw","label":"Mega Whale erd18mv2z6r2 (PAUSED - flat at 1.04M after 2 accumulation weeks; the absorber stepped back as OTC reloaded)","balance_egld":b("erd18mv2z6r2ksn4rfmm52tmhkc6x5tz6achmynvxftq4ay927029qqqmqpzfw"),"weeks_tracked":13,"first_seen":"2026-04-20"},
   {"address":"erd1vj3efd5czwearu0gr3vjct8ef53lvtl7vs42vts2kh2qn3cucrnsj7ymqx","label":"Bybit cold (-221K this week, largest exchange move, UNTRACED; watch for round-trip re-inflow vs OTC/routing appearance)","balance_egld":b("erd1vj3efd5czwearu0gr3vjct8ef53lvtl7vs42vts2kh2qn3cucrnsj7ymqx"),"weeks_tracked":1,"first_seen":"2026-07-13"},
   {"address":"erd17l22xekj5lvfulatz20xr0llxky6c8zr923r95qg3pfx668m862skjdveh","label":"OTC source erd17l22 (~7.2K inbound 7d from Binance; still feeding the pipeline that reloaded the desks)","balance_egld":b("erd17l22xekj5lvfulatz20xr0llxky6c8zr923r95qg3pfx668m862skjdveh"),"weeks_tracked":10,"first_seen":"2026-05-11"},
   {"address":"erd12tq6ax5k49dkp4lwmuvdv8sa9df5mqjnrv2mmjnxkv4m5ns562vsmtaujp","label":"OTC source funder (Binance.com -> erd17l22 pass-through)","balance_egld":b("erd12tq6ax5k49dkp4lwmuvdv8sa9df5mqjnrv2mmjnxkv4m5ns562vsmtaujp") or 0,"weeks_tracked":8,"first_seen":"2026-05-25"},
   {"address":"erd1qqqqqqqqqqqqqpgq6uzdzy54wnesfnlaycxwymrn9texlnmyah0ssrfvk6","label":"XOXNO LSD contract (XEGLD supply RE-ACCUMULATING +4.5% to 236,685 after the -29% collapse; leverage/LSD returning)","balance_egld":b("erd1qqqqqqqqqqqqqpgq6uzdzy54wnesfnlaycxwymrn9texlnmyah0ssrfvk6") or 0,"weeks_tracked":3,"first_seen":"2026-06-29"}]}
...
# UPbit OTC +117,356 + OTC Distribution +120,361 = +237,717 (RECORD LOADING - biggest in tracking - while distributing ~323K)
otc_throughput_13 = 237717
new_baselines={
